...
2. По profile построй search matrix: системы, запросы, authority, freshness и
   ...
   Независимые запросы известной матрицы выполни одним batch/parallel round.
   Следующий round разрешён для вопросов, возникших из фактических результатов.
...
4. Выполни read-only поиск через project adapters. Фиксируй и найденные, и
   ...
   Узкие previews используй для навигации; выбранный source unit прочитай
   полностью и зафиксируй pagination/completeness. Если воспроизводишь
   неописанную project-конвенцию без канонического profile/template, сравни два
   релевантных примера, а не один.
