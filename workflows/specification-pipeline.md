# Мультиагентный pipeline постановки

## Фаза 1. Инициализация или возобновление

**Вход:** запрос пользователя, выбранные `profile_id` и `route_id`.

1. Найди существующий case package текущего результата.
2. Если его нет, создай manifest по handoff-контракту в рабочей области
   координатора, не в каноническом каталоге проекта.
...
**Выход:** manifest существует, входы и следующая фаза определены.
...
**Выход:** независимый review report.
