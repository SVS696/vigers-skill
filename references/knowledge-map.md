...
```json
{
  ...
  "routes": [
    ...
    },
    {
      ...
      "signals": ["трассировка", "traceability", "матрица требований", "связи требований", "uc fr", "требование тест"],
    ...
    },
    {
      ...
      "signals": ["риск требований", "оценка рисков", "риск выявления", "риск анализа", "расползание границ", "нереализованное требование"],
    ...
    },
    {
      ...
      "signals": ["моделирование требований", "диаграмма", "mermaid", "plantuml", "дерево решений", "контекстная диаграмма", "таблица решений"],
      "core": ["5. Смоделируй поведение"],
      "distilled": [
        {"file": "references/native-diagrams.md", "heading": "D14. Модель данных учета химикатов — стр. 68"},
    ...
    },
    {
      ...
      "signals": ["карта изображений", "исходная страница", "происхождение диаграммы", "соответствие конвертации", "d01", "t01", "c01"],
